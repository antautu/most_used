########## INFO ##########
# Produces x vs y position plots for the disk using small 0.1 kpc slices in the z-direction 
import math
import numpy as np
...
for num1 in range(5):
	for num2 in range(10):
		...
		for i in range(len(disk_centered_z)):
			if disk_centered_z[i] > 0.3:
				x1.append(disk_centered_x[i])
				y1.append(disk_centered_y[i])
		...
		for i in range(len(disk_centered_z)):
			if 0.3 > disk_centered_z[i] > 0.2:
				x2.append(disk_centered_x[i])
				y2.append(disk_centered_y[i])
		...
		for i in range(len(disk_centered_z)):
			if 0.2 > disk_centered_z[i] > 0.1:
				x3.append(disk_centered_x[i])
				y3.append(disk_centered_y[i])
		...
		for i in range(len(disk_centered_z)):
			if 0.1 > disk_centered_z[i] > 0.0:
				x4.append(disk_centered_x[i])
				y4.append(disk_centered_y[i])
		...
		for i in range(len(disk_centered_z)):
			if 0.0 > disk_centered_z[i] > -0.1:
				x5.append(disk_centered_x[i])
				y5.append(disk_centered_y[i])
		...
		for i in range(len(disk_centered_z)):
			if -0.1 > disk_centered_z[i] > -0.2:
				x6.append(disk_centered_x[i])
				y6.append(disk_centered_y[i])
		...
		for i in range(len(disk_centered_z)):
			if -0.2 > disk_centered_z[i] > -0.3:
				x7.append(disk_centered_x[i])
				y7.append(disk_centered_y[i])
		...
		for i in range(len(disk_centered_z)):
			if disk_centered_z[i] < -0.3:
				x8.append(disk_centered_x[i])
				y8.append(disk_centered_y[i])
		...
		### z > 0.3 ###
		plt.suptitle('Subsampled disk z values for t = %d%d' % (num1, num2), fontsize=34)							### Make sure to change time label ###
		plt.subplot(241)
		plt.plot(x1_sub, y1_sub, '.', markersize=3, alpha=0.3)
		plt.title('z > 0.3', fontsize=28)
		...
		plt.title('0.3 > z > 0.2', fontsize=28)
		plt.xticks(fontsize=22)
		plt.yticks(fontsize=22)
		plt.axis([-25, 25, -25, 25])
		plt.gca().set_aspect('equal', adjustable='box')
		...
		plt.title('0.2 > z > 0.1', fontsize=28)
		plt.xticks(fontsize=22)
		plt.yticks(fontsize=22)
		plt.axis([-25, 25, -25, 25])
		plt.gca().set_aspect('equal', adjustable='box')
		...
		plt.title('0.1 > z > 0.0', fontsize=28)
		plt.xticks(fontsize=22)
		plt.yticks(fontsize=22)
		plt.axis([-25, 25, -25, 25])
		plt.gca().set_aspect('equal', adjustable='box')
		...
		plt.title('0.0 > z > -0.1', fontsize=28)
		plt.text(-35, 37, 'y (kpc)', fontsize=28, rotation='vertical')
		plt.xticks(fontsize=22)
		plt.yticks(fontsize=22)
		plt.axis([-25, 25, -25, 25])
		plt.gca().set_aspect('equal', adjustable='box')
		...
		plt.title('-0.1 > z > -0.2', fontsize=28)
		plt.text(25, -35, 'x (kpc)', fontsize=28)
		plt.xticks(fontsize=22)
		plt.yticks(fontsize=22)
		plt.axis([-25, 25, -25, 25])
		plt.gca().set_aspect('equal', adjustable='box')
		...
		plt.title('-0.2 > z > -0.3', fontsize=28)
		plt.xticks(fontsize=22)
		plt.yticks(fontsize=22)
		plt.axis([-25, 25, -25, 25])
		plt.gca().set_aspect('equal', adjustable='box')
